...
For a detailed history and analysis of each color space — OKLCH, CIELCH, LCHUV, SRLCH, JzCzHz, and Munsell — including their design rationale, known tradeoffs, and guidance on when to use each, see [colorspaces.md](colorspaces.md).
